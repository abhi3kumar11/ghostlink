...
function App() {
  ...
  useEffect(() => {
    // Simulate generating anonymous ID
    setTimeout(() => {
      setAnonId('ANON_' + Math.random().toString(36).substr(2, 8).toUpperCase())
      setIsLoading(false)
    }, 1000)
  }, [])
  ...
  return (
    <div className="min-h-screen bg-base-100">
            ...
            <div className="btn btn-ghost btn-circle avatar placeholder">
              <div className="bg-primary text-primary-content rounded-full w-10">
                <span className="text-xs font-bold">
                  {anonId ? anonId.slice(5, 7).toUpperCase() : 'AN'}
                </span>
              </div>
            </div>
          </div>
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        {currentView === 'chat' && <ChatView anonId={anonId} />}
        {currentView === 'video' && <VideoView anonId={anonId} />}
